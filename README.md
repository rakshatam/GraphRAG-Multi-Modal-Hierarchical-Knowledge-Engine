...
* **True GraphRAG Retrieval:** Moves beyond 1-hop vector search. Our retrieval logic uses **2-hop undirected traversal** to find connections between entities that aren't semantically similar but are logically linked.
